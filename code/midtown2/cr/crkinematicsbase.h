...
class crKinematicsBase
{
public:
    // ??0crKinematicsBase@@QAE@XZ
    ARTS_IMPORT crKinematicsBase();

    // ??1crKinematicsBase@@UAE@XZ
    ARTS_IMPORT virtual ~crKinematicsBase();
...
// vtable at 0x005B63D4
// check_size(crKinematicsBase, 0x0); // TODO: no layout in the IDB type library
