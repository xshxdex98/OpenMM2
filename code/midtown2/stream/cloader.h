...
private:
    ...
    ARTS_IMPORT ilong LoadFromFile(_DMUS_OBJECTDESC* arg1, IDirectMusicObject** arg2);

    // ?LoadFromMemory@CLoader@@AAEJPAU_DMUS_OBJECTDESC@@PAPAUIDirectMusicObject@@@Z
    ARTS_IMPORT ilong LoadFromMemory(_DMUS_OBJECTDESC* arg1, IDirectMusicObject** arg2);
};

// ??_7CLoader@@6B@
// vtable at 0x005B4D30
// check_size(CLoader, 0x0); // TODO: no layout in the IDB type library
